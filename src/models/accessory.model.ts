...
import type { IAccessoryBase } from "../types/product.types"

export interface IAccessory extends IAccessoryBase, Document {
  createdAt: Date
  updatedAt: Date
}
...
AccessorySchema.index({ compatibleProductIds: 1 })
